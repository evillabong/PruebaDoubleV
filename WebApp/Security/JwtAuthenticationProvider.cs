...
{
    public class JwtAuthenticationProvider : AuthenticationStateProvider , IJwtSessionService
    {
        ...
        public async override Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            //await httpClient.CheckEntityHandler();
        ...
        {
            await js.RemoveStorage(TokenKey);
            //await httpClient.GetLogout();
        ...
        public async Task<T?> GetIdentity<T>()
        {
            return await js.GetItemObject<T>(Common.Constants.IDENTITY);
        }
    }
